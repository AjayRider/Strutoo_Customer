...
import com.strutoocustomer.databinding.ProfileSetupBinding
...
class ProfileSetup : Fragment() {
    ...
    private val binding: ProfileSetupBinding by lazy { ProfileSetupBinding.inflate(layoutInflater).apply {
        model = viewModel
    } }
